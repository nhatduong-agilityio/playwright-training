...
When('I open and wait for view the details for the first seeded user', async ({ tablePage, page, ctx }) => {
...
Then('I should see the user details displayed correctly', async ({ dashboardPage, ctx }) => {
